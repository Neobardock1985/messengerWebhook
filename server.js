...
client.connect(config.websocketServer, 'echo-protocol');
    ...
    if (body.object === 'page') {
        ...
        body.entry.forEach(function (entry) {
            ...
            if (webhookEvent.message) {
                GraphApi.callSendMessages(senderPsid, webhookEvent.message);
                socketClient.send(JSON.stringify(webhookEvent.message));
